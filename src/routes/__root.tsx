    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/dashboard"
            className="rounded-full border border-foreground/20 bg-card px-6 py-2.5 text-sm font-medium"
          >
            Dashboard
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AutoApply — Apply smarter. Let AI handle your inbox." },
      {
        name: "description",
        content:
          "AutoApply turns LinkedIn job posts into ready-to-send emails from your own Gmail.",
      },
    ],
